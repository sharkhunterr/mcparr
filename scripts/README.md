# Scripts de Release et Déploiement MCParr
...
**Prérequis :**
- Remote GitHub configuré : `git remote add github https://github.com/sharkhunterr/mcparr.git`
...
- ✅ Push vers Docker Hub (`sharkhunterr/mcparr`)
...
- **GitLab** : https://gitlab.com/mcparr/mcparr/-/releases
- **GitHub** : https://github.com/sharkhunterr/mcparr/releases
- **Docker Hub** : https://hub.docker.com/r/sharkhunterr/mcparr
- **GitLab CI** : https://gitlab.com/mcparr/mcparr/-/pipelines

## 🔧 Configuration

### Ajouter le remote GitHub
```bash
git remote add github https://github.com/sharkhunterr/mcparr.git
```
